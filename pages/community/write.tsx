  ...
  return (
    <div className="h-screen py-12 px-10 space-y-5 text-gray-700 bg-gradient-to-br from-orange-50 to-orange-100">
      ...
      <form>
        <textarea
          rows={8}
          className="appearance-none w-full shadow-md rounded-lg bg-gradient-to-br from-orange-50 to-orange-100 placeholder-gray-400 border-orange-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 transition"
        />
