...
const Home: NextPage = () => {
  return (
    <div className="flex flex-col space-y-5 py-12 bg-gradient-to-br from-orange-50 to-orange-100">
        ...
        >
          ...
          <div className="flex space-x-2">
            <div className="flex items-center space-x-0.5 text-gray-700">
              <svg
                className="w-4 h-4 hover:scale-150 hover:text-red-500 transition"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div className="flex items-center space-x-0.5 text-gray-700">
              <svg
                className="w-4 h-4 hover:scale-150 hover:text-orange-500 transition"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
