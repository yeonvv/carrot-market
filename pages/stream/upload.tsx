          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center relative">
              ...
              <input
                ...
                type="text"
                placeholder="0.00"
                className="appearance-none w-full pl-7 shadow-md rounded-lg bg-gradient-to-br from-orange-50 to-orange-100 placeholder-gray-400 border-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 transition"
              />
